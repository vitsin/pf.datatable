...
public class ProductService {
    ...
    public List<Product> pickRandomProducts(int number) 
    {
    	List<Product> selectedProducts = new ArrayList<Product>(products);
    	Collections.shuffle(selectedProducts);
        
        return number > selectedProducts.size() ? selectedProducts.subList(0, selectedProducts.size()) : selectedProducts.subList(0, number);
    }
}